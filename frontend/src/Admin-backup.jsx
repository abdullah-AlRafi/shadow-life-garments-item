...
function Admin() {
  ...
  const handleDeleteCategory = async (category) => {
    ...
    if (productsInCategory.length > 0) {
      message += `\n\n${productsInCategory.length} product(s) currently use this category. Their category will become empty.`;
    }
      ...
      <div className="admin-container">
        ...
        <div className="admin-header">
          <div>
            ...
            <p>Admin Dashboard — Products, Categories, Orders & Payments</p>
          </div>
